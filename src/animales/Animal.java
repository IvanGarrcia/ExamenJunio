...
public abstract class Animal {
    ...
    /**
     * ¿Cuáles son los parámetros del método?
     * 
     ...
     * @param fechaNacimiento  Cadena conteniendo la fecha que se quiere asignar al animal como fecha de nacimiento. La cadena deberá de seguir el siguiente formato: 
     ...
     * Si el número del mes solo tiene una cifra, deberá ponerse un 0 delante. Ejemplo: 02 para febrero - Un guión (-) o una barra (/) para separar el mes del año. 
     ...
     * 
     * Lanza la excepción IllegalArgumentException si alguno de los argumentos no cumple con las condiciones establecidas para ser considerados correctos.
     */
